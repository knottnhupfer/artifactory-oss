...
public interface PackageNativeModelHandler {
    ...
    void mergeFields(PackageNativeModel packageNative, PackageNativeSearchResult packageResult);

    void mergeVersionFields(VersionNativeModel packageNative, PackageNativeSearchResult packageResult);

    void mergeSummaryFields(NativeSummaryModel packageSummery, PackageNativeSearchResult packageResult);

    String getPackageName(PackageNativeSearchResult packageResult);

    String getPackageVersion(PackageNativeSearchResult packageResult);
