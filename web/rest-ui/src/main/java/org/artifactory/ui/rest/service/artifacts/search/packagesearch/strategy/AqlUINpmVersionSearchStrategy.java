...
public class AqlUINpmVersionSearchStrategy extends AqlUIPropertySearchStrategy {
    ...
    public AqlUINpmVersionSearchStrategy(String key, AqlDomainEnum[] subdomainPath) {
    ...
    public AqlBase.OrClause toQuery() {
        ...
        values.forEach(value ->
                query.append(new AqlBase.PropertyCriteriaClause(key, comparator, value, subdomainPath)));
        return query;
    }
