...
public class GetAllGroupsService implements RestService {
    ...
    public void execute(ArtifactoryRestRequest request, RestResponse response) {
        ...
        List<Acl<? extends PermissionTarget>> acls = aclService.getAllAcls();
    ...
    private Group addGroupPermissions(Group group, List<Acl<? extends PermissionTarget>> acls) {
    ...
    private Predicate<Acl<? extends PermissionTarget>> groupPermissionTargets(String groupName) {
        return acl -> acl.getMutableAces().stream()
                .filter(AceInfo::isGroup)
                .anyMatch(aceInfo -> groupName.equalsIgnoreCase(aceInfo.getPrincipal()));
    }
}
