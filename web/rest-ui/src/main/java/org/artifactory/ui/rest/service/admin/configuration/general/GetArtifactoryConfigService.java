...
public class GetArtifactoryConfigService implements RestService<GeneralConfig> {
    ...
    public void execute(ArtifactoryRestRequest<GeneralConfig> request, RestResponse response) {
        ...
        ArtifactoryConfig artifactoryConfig = new ArtifactoryConfig(descriptor);
        response.iModel(artifactoryConfig);
    }
}
