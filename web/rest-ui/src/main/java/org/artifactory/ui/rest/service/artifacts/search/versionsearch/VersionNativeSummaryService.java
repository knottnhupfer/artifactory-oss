...
public class VersionNativeSummaryService implements RestService {

    private NativeSummaryHelper nativeSummaryHelper;

    @Autowired
    public VersionNativeSummaryService(NativeSummaryHelper nativeSummaryHelper) {
    ...
    public void execute(ArtifactoryRestRequest request, RestResponse response) {
        ...
        NativeSummaryModel summaryModel = nativeSummaryHelper
                .getSummary(searchControls, searchControls.getModelHandler().getVersionPropKey());
