...
public class VersionsNativeModel {
    private List<VersionNativeModel> results = Lists.newArrayList();
    private String errorStatus;

    public VersionsNativeModel(List<VersionNativeModel> versionResults) {
        this.results = versionResults;
    }
}
