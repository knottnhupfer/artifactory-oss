...
public class GetPlatformConfigService implements RestService<PlatformConfig> {
    ...
    public void execute(ArtifactoryRestRequest<PlatformConfig> request, RestResponse response) {
        ...
        platformConfig.setForceBaseUrl(descriptor.isForceBaseUrl());
        response.iModel(platformConfig);
    }
