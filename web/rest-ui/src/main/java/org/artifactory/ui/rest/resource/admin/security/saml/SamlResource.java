...
public class SamlResource extends BaseResource {
    ...
    public Response getPublicCertificateForEncryption() {
        return runService(securityFactory.getPublicCertificateForEncryption());
    }

    @PUT
    @Path("key/public/regenerate")
    @Produces(MediaType.TEXT_PLAIN)
    public Response regeneratePublicCertificateForEncryption() {
        return runService(securityFactory.regenerateSAMLPublicCertificateForEncryption());
    }
