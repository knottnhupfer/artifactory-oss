...
public class MoveArtifactService implements RestService {
    ...
    private void moveArtifact(RestResponse artifactoryResponse, MoveArtifact moveAction) {
        ...
        try {
            ...
            updateResponseData(artifactoryResponse, moveAction, copyStatus);
        } catch (Exception e) {
            log.debug("{}", e);
     ...
     */
    private void updateResponseData(RestResponse artifactoryResponse, MoveArtifact moveArtifact,
