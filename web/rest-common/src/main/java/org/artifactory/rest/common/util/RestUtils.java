...
public abstract class RestUtils {
    ...
    public static final String APPLICATION_JSON_MERGE = MediaType.APPLICATION_JSON + "+merge-patch";
    ...
    public static String getBuildRelativeHref(String buildName) {
        return "/" + HttpUtils.encodeQuery(buildName);
    }

    public static String getBuildNumberRelativeHref(String buildNumber) {
     ...
     */
     public static boolean shouldDecodeParams(HttpServletRequest request) {
        ...
        return !snapshotCondition && !newVersionCondition;
    }
