...
public class SearchResource {
    ...
    public ArtifactSearchResource artifactQuery() {
        return new ArtifactSearchResource(authorizationService, searchService, repositoryService, propertiesService,
                request, repoBrowsingService);
    }
    ...
    public GavcSearchResource gavcQuery() {
        return new GavcSearchResource(authorizationService, searchService, repositoryService, propertiesService,
                repoBrowsingService, request);
    }
    ...
    public PropertySearchResource propertyQuery() {
        return new PropertySearchResource(authorizationService, searchService, repositoryService, propertiesService,
                repoBrowsingService, request);
    }
    ...
    public ChecksumSearchResource checksumSearch() {
        RestAddon restAddon = addonsManager.addonByType(RestAddon.class);
        return new ChecksumSearchResource(authorizationService, restAddon, repositoryService, propertiesService,
                repoBrowsingService, request);
    }
