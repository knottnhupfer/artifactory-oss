...
public class ExportSettingsConfigurationImpl {
    ...
    public boolean isExplicitIncludeMetadata() {
        return explicitIncludeMetadata;
    }

    public void setExplicitIncludeMetadata(boolean explicitIncludeMetadata) {
        this.explicitIncludeMetadata = explicitIncludeMetadata;
    }

    public boolean isExcludeArtifactBundles() {
        return excludeArtifactBundles;
    }
