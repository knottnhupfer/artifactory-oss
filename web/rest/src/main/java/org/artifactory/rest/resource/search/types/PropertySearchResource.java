...
public class PropertySearchResource {
    ...
    public PropertySearchResource(AuthorizationService authorizationService, SearchService searchService,
            RepositoryService repositoryService, PropertiesService propertiesService,
    ...
    private Response search(List<String> reposToSearch) throws IOException {
        ...
        results = results.stream()
                .filter(propertySearchResult -> authorizationService.canRead(propertySearchResult.getItemInfo().getRepoPath()))
        ...
        for (PropertySearchResult result : results) {
            ...
            StorageInfoHelper storageInfoHelper = new StorageInfoHelper(request, repositoryService, propertiesService,
                    repoBrowsingService, itemInfo);
