...
(1, 'bundle1', '1.0.0', 'STATUS', 1349000000000, 'sig1', 'TARGET', NULL),
(2, 'bundle2', '1.0.1', 'STATUS', 1349000000001, 'sig2', 'TARGET', NULL ),
(3, 'sorceBundle', '1.0.2', 'STATUS', 1349000000002, 'another_sig3', 'SOURCE', 'repo');

INSERT INTO bundle_files VALUES
(1, 5, 1, 'repo1:ant/ant/1.5/ant-1.5.jar', NULL),
(2, 5, 2, 'repo1:ant/ant/1.5/ant-1.5.jar', NULL),
(3, 5, 3, 'repo1:ant/ant/1.5/ant-1.5.jar', NULL),
(4, 11, 2, 'repo1:org/yossis/tools/test.bin', NULL),
(5, 11, 3, 'repo1:org/yossis/tools/test2.bin', '{"a":"B"}');