...
public class BuildArtifactsDaoTest extends BuildsDaoBaseTest {
    ...
    public void testCreateSimpleArtifact() throws SQLException {
    ...
    public void testCreateMultipleArtifacts() throws SQLException {
    ...
    public void testCreateNullChecksumsDependencies() throws SQLException {
        ...
        Assert.assertEquals(buildArtifactsDao.createBuildArtifacts(bas), 4);
        List<BuildArtifact> artifacts = buildArtifactsDao
                .findArtifactsForModules(buildModulesDao.findModuleIdsForBuild(build14));
        Assert.assertEquals(artifacts.size(), 4);
    }
    ...
    private void assertFoundArtifact1001(List<BuildArtifact> artifacts) {
        ...
        Assert.assertNull(buildArtifact.getSha2());
