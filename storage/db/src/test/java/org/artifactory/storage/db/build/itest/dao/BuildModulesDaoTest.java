...
public class BuildModulesDaoTest extends BuildsDaoBaseTest {
    ...
    public void testFullDelete() throws SQLException {
        ...
        assertEquals(buildsDao.deleteAllBuilds(false), 21);
    }
    ...
    public void testSimpleCreateBuildModule() throws SQLException {
    ...
    public void testCreateTwoBuildModulesWithProperties() throws SQLException {
        ...
        for (BuildModule module : modulesForBuild) {
            switch ((int) module.getModuleId()) {
                ...
                case 202:
                    ...
                    assertEquals(module.getProperties().size(), 5);
                    module.getProperties().forEach(moduleProperty ->
                            assertTrue(moduleProperty.getPropValue().length() <=
                                    buildModulesDao.getDbIndexedValueMaxSize(2048)));
                    break;
                default:
    ...
    public void testDeleteBuildModules() throws SQLException {
        doDelete(11L, 1, 1);
        doDelete(12L, 2, 9);
    }
    ...
    private void assertAnyBuildModuleList(List<BuildModule> b) {
        assertNotNull(b);
