...
import static org.artifactory.storage.db.aql.parser.AqlParser.releaseBundleFileDomains;

/**
 * @author Nadavy
 */
public class ReleaseBundleDomainsElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        list.add(new IncludeDomainElement(releaseBundles));
    }
