 ...
 * @author Nadavy
 */
public class ReleaseBundleFileValuesElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        list.add(forward(new InternalNameElement(releaseBundles.signature), dot, releaseBundlesValues));
