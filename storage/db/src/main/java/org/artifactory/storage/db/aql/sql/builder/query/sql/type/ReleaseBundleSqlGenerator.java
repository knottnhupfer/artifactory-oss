...
/**
 * The class contains tweaking information and optimizations for release bundles queries.
 *
 * @author Nadavy
 */
public class ReleaseBundleSqlGenerator extends BasicSqlGenerator {

    @Override
    protected SqlTableEnum[] getMainTables() {
        return arrayOf(SqlTableEnum.artifact_bundles);
    }
