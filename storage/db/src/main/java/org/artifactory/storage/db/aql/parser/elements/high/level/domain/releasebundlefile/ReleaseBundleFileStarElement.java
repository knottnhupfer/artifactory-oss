 ...
 * @author Nadavy
 */
public class ReleaseBundleFileStarElement extends LazyParserElement implements DomainProviderElement {
    @Override
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        list.add(forward(new InternalNameElement(releaseBundles.signature), dot, releaseBundlesStar));
