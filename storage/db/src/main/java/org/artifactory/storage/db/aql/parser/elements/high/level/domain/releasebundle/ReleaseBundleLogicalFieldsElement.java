...
import static org.artifactory.storage.db.aql.parser.AqlParser.releaseBundleFilesLogicalFields;

/**
 * @author Nadavy
 *         Acepts the releaese bundle fields and its sub domain
 */
public class ReleaseBundleLogicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlLogicalFieldEnum[] fields = releaseBundles.getLogicalFields();
