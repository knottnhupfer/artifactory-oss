...
/**
 * The class contains tweaking information and optimizations for release bundle artifacts queries.
 *
 * @author Nadavy
 */
public class ReleaseBundleFileSqlGenerator extends BasicSqlGenerator {
    @Override
    protected SqlTableEnum[] getMainTables() {
        return arrayOf(SqlTableEnum.bundle_files);
    }
