 ...
 */
public class ReleaseBundleFilePhysicalFieldsElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithDomainFields(List<ParserElement> list) {
        AqlPhysicalFieldEnum[] fields = releaseBundleFiles.getPhysicalFields();
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        list.add(forward(new InternalNameElement(releaseBundles.signature), dot, releaseBundlesPhysicalFields));
