...
import static org.artifactory.storage.db.aql.parser.AqlParser.releaseBundleFilesStar;

/**
 * @author Nadavy
 */
public class ReleaseBundleStarElement extends LazyParserElement implements DomainProviderElement {
    ...
    private void fillWithSubDomains(List<ParserElement> list) {
        list.add(forward(new InternalNameElement(releaseBundleFiles.signature), dot, releaseBundleFilesStar));
    }
