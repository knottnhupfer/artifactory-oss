ALTER TABLE artifactory_servers  DROP CONSTRAINT artifactory_servers_pk;
ALTER TABLE artifactory_servers ALTER COLUMN server_id VARCHAR(128) NOT NULL;
ALTER TABLE artifactory_servers ADD CONSTRAINT artifactory_servers_pk PRIMARY KEY (server_id);
