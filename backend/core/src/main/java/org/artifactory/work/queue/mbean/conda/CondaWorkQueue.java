...
package org.artifactory.work.queue.mbean.conda;
 ...
 * @author Dudi Morad
 */
public class CondaWorkQueue implements CondaWorkQueueMBean {
    private WorkQueueMBean workQueueMBean;

    public CondaWorkQueue(WorkQueueMBean workQueueMBean) {
