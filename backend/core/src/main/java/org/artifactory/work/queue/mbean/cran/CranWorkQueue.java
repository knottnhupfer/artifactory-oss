...
package org.artifactory.work.queue.mbean.cran;
 ...
 * @author Yuval Reches
 */
public class CranWorkQueue implements CranWorkQueueMBean {
    private WorkQueueMBean workQueueMBean;

    public CranWorkQueue(WorkQueueMBean workQueueMBean) {
