...
public class RepoIndexer extends DefaultIndexer implements ArtifactScanningListener {
    ...
    RepoIndex index(Date fireTime) throws Exception {
    ...
    RepoIndex createIndex(boolean scan) throws IOException {
        try {
            ...
            return new RepoIndex(zipIndexHandle, propertiesHandle, outputFolder);
        } catch (Exception e) {
