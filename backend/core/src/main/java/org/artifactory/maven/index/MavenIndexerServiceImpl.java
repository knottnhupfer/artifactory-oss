    ...
    public void index(MavenIndexerRunSettings settings) {
        ...
        for (RealRepo indexedRepo : indexedRepos) {
            ...
            try {
                ...
                //trace
                Throwable cause = ExceptionUtils.getCauseOfType(e, SocketTimeoutException.class);
                if (cause != null) {
        ...
        try {
            ...
            for (VirtualRepo virtualRepo : virtualRepos) {
                ...
                try {
                    ...
                    RepoIndex repoIndex = indexer.createIndex(false);
                    MavenIndexManager mavenIndexManager = new MavenIndexManager(indexer.getRepo(), repoIndex);
                    mavenIndexManager.saveIndexFiles();
                } finally {
                    if (indexer != null) {
