...
@Component
public class ArtifactoryLdapAuthenticator implements InternalLdapAuthenticator, LicenseEventListener {
        ...
        if (searchPattern != null) {
            if (PathUtils.hasText(searchPattern.getManagerDn())) {
                ...
                contextSource.setPassword(
                        CryptoHelper.decryptIfNeeded(ArtifactoryHome.get(), searchPattern.getManagerPassword()));
            } else {
