...
public class RemoteReplicationSettingsBuilder {
    ...
    public RemoteReplicationSettingsBuilder checkBinaryExistenceInFilestore(boolean checkBinaryExistenceInFilestore) {
    ...
    public RemoteReplicationSettings build() {
        ...
        return new RemoteReplicationSettings(repoPath, progress, mark, deleteExisting, includeProperties,
                checkBinaryExistenceInFilestore,  overwrite, responseWriter, url, socketTimeoutMillis);
    }
}
