...
public class DockerCacheKey extends ArtifactoryCacheKey {
    ...
    public DockerCacheKey(String user, String basicauth, String repoKey,
        ...
        super(user, basicauth, repoKey, authenticationDetailsSource, servletRequest);
    }

    @Override
    public ProviderMgr getProviderMgr() {
        return new DockerProviderMgr(authenticationDetailsSource, basicauth, servletRequest);
    }
}
