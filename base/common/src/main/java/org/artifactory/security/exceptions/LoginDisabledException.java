...
public class LoginDisabledException extends DisabledException {
     ...
     */
    public static LoginDisabledException userLocked(long retryAt) {
        return new LoginDisabledException(retryAt);
    }
     ...
     * @return {@link LoginDisabledException}
     */
    public static LoginDisabledException sessionLocked(long retryAt) {
        return new LoginDisabledException(retryAt);
    }
}
