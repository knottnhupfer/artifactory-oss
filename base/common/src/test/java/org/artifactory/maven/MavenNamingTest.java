...
public class MavenNamingTest extends ArtifactoryHomeBoundTest {
    ...
    public void testIsNonUniqueSnapshotFilePath() {
        ...
        assertFalse(MavenNaming.isNonUniqueSnapshot("a/path/1.0/1.0-SNAPSHOT.pom"));
        assertFalse(MavenNaming.isNonUniqueSnapshot("a/path/1.0-SNAPSHOT/1.0.pom"));
        assertFalse(MavenNaming.isNonUniqueSnapshot("a/path/1.0-SNAPSHOT/artifact-5.4-20081214.090217-4.pom"));
        assertFalse(MavenNaming.isNonUniqueSnapshot("org.apache.ivy.example/console/1.0-20141216103631/jars/console-1.0-20141216103631.jar"));
        assertFalse(MavenNaming.isNonUniqueSnapshot("org.apache.ivy.example/console/1.0-20141216103631/jars/console-1.0-SNAPSHOT.jar"));
    }
    ...
    public void testIsVersionUniqueSnapshot() {
        ...
        assertFalse(MavenNaming.isUniqueSnapshot("g/a/1.0-SNAPSHOT/release/artifact-5.4-20081214.090217-4.pom"));
        assertFalse(MavenNaming.isUniqueSnapshot("g/a/1.0-SNAPSHOT/release/artifact-5.4-SNAPSHOT.pom"));
        assertFalse(MavenNaming.isUniqueSnapshot("a/path/5.4-20081214.090217-4/1.0.pom"));
    }
    ...
    public void isMetadata() {
        assertFalse(MavenNaming.isMavenMetadata("artifacts.jar"));
    ...
    public void isIndex() {
        assertFalse(MavenNaming.isIndex("artifacts.jar"));
        assertTrue(MavenNaming.isIndex("nexus-maven-repository-index"));
        assertTrue(MavenNaming.isIndex("nexus-maven-repository-index.zip"));
        assertTrue(MavenNaming.isIndex("nexus-maven-repository-index.properties"));
    }
