...
public class ReleaseBundlesConfig implements Descriptor {
    ...
    public Long getIncompleteCleanupPeriodHours() {
        return incompleteCleanupPeriodHours;
    }

    public void setIncompleteCleanupPeriodHours(Long incompleteCleanupPeriodHours) {
        this.incompleteCleanupPeriodHours = incompleteCleanupPeriodHours;
    }
}
